        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2.5 px-3.5 py-2 rounded-lg border border-slate-200 bg-slate-50 hover:bg-slate-100 hover:border-slate-300 transition text-left cursor-pointer focus:outline-none focus:ring-2 focus:ring-amber-500/20"
            >
          ...
          <div className="flex items-center gap-2">
            ...
            {onOpenNewInvoice && (
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg text-xs font-semibold shadow-xs transition cursor-pointer"
              >
            ...
            <button
              id="reset-demo-btn"
              onClick={() => {
                if (confirm('Reset to initial sample Tally company, debtors, items & invoices?')) {
                  resetToDemoData();
                }
              }}
