...
echo Downloading portable Node.js runtime for Tally Connector...
...
echo.
echo ================================================
echo Error: Node.js runtime could not be prepared.
...
if not exist "%~dp0tally-connector.mjs" (
  ...
  curl.exe -L --fail --retry 2 "https://raw.githubusercontent.com/anishhfgpl-uk/invoice/main/tally-connector/tally-connector.mjs" -o "%~dp0tally-connector.mjs"
)
